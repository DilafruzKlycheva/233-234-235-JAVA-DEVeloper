...
public class Arrays01 {
    ...
    */
        ...
        for (int i = 0; i < cities.length;  i++) {  //Bu length field'dir. Alan okumasi yapar.

            totalChar = totalChar + cities[i].length();  //Bu length() method'dur. String'e uygulanir. Dinamiktir
