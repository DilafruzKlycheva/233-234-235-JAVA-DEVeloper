...
public class Sets01 {
    public static void main(String[] args) {
        ...
        //Set’ler tekrarsiz(unique-benzersiz) datalari depolamak icin kullanilir.
        ...
        System.out.println(hs); //[] //hiclik var, null yok
