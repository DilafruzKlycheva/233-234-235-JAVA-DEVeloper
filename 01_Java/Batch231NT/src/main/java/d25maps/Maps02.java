...
public class Maps02 {
    public static void main(String[] args) {
        ...
        System.out.println(stdAges); //{Can=19, Ahmet=41, Tom=45, Veli=63, Ali=18} 77 eklenmez
        //cunku key olan Tom map'te var

        stdAges.putIfAbsent("Ayse", 23);
        System.out.println(stdAges); //{Can=19, Ahmet=41, Tom=45, Veli=63, Ayse=23, Ali=18} eklendi
        //cunku Ayse key'i map'te yoktu
        //-----------------------------
        ...
        System.out.println(stdAges.getOrDefault("Tom", 18)); //45 - Tom map'te var, value'su geldi

        System.out.println(stdAges.get("Jerry")); //null - get map'te key yoksa null dondurur
        System.out.println(stdAges.getOrDefault("Jerry", -1)); //Jerry map'te yok, default deger geldi
