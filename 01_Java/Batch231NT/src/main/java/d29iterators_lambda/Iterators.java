...
public class Iterators {
    public static void main(String[] args) {
        ...
        ListIterator<String> lisItr2 = yourList2.listIterator(); //[Ali, Can, Aliye]
        ...
        while (lisItr2.hasPrevious()){ //onceki eleman var mi diye kontrol ettik
            String el = lisItr2.previous(); //previous pointer;i sagdan sola alir
